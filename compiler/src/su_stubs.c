...
/* preprocess.preprocess_su_buf 桥接：
 * SU 生成的 preprocess_su.o 导出 _typeck_preprocess_su_buf，
 * 但 pipeline.su 和 driver.su 引用它为 preprocess.preprocess_su_buf → _preprocess_preprocess_su_buf。
 * 此桥接将调用转给实际实现。 */
