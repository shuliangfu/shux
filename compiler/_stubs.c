...
extern int32_t typeck_preprocess_su_buf(const uint8_t*,ptrdiff_t,uint8_t*,int32_t);
int32_t preprocess_preprocess_su_buf(const uint8_t*s,ptrdiff_t l,uint8_t*o,int32_t c){return typeck_preprocess_su_buf(s,l,o,c);}
