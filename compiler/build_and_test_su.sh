...
CFLAGS_DRIVER="$CFLAGS -DSHU_USE_SU_DRIVER -DSHU_USE_SU_PIPELINE -DSHU_USE_SU_FRONTEND -DSHU_USE_SU_PREPROCESS"
...
cc $CFLAGS -o shu $OBJS
cc $CFLAGS -o shu-c $OBJS

echo "=== 1. Relink shu with fixed runtime ==="
cc $CFLAGS -c src/runtime.c -o src/runtime.o
cc $CFLAGS -o shu src/main.o src/runtime.o src/preprocess.o src/lexer/lexer.o src/ast/ast.o src/parser/parser.o src/typeck/typeck.o src/codegen/codegen.o src/lsp/lsp_diag.o

echo "=== 2. Generate all _gen.c ==="
./shu -L .. -L src/lexer -L src/ast -E -E-extern src/parser/parser.su > parser_gen.c
./shu -L .. -L src/lexer -L src/ast -E -E-extern src/typeck/typeck.su > typeck_gen.c
./shu -L .. -L src/lexer -L src/ast -L src/parser -L src/typeck -E -E-extern src/codegen/codegen.su > codegen_gen.c
./shu -E -E-extern src/ast/ast.su > ast_gen.c
./shu -L src/lexer -E -E-extern src/lexer/token.su > token_gen.c
./shu -L src/lexer -E -E-extern src/lexer/lexer.su > lexer_gen.c
./shu -L src/lexer -E -E-extern src/preprocess/preprocess.su > preprocess_gen.c
./shu -L .. -L . -L src -L src/lexer -L src/ast -L src/parser -L src/typeck -L src/codegen -L src/asm -L src/preprocess -E -E-extern src/pipeline/pipeline.su > pipeline_gen.c
./shu -L .. -L . -L src -L src/lexer -L src/ast -L src/parser -L src/typeck -L src/codegen -L src/preprocess src/main.su -E -E-extern > driver_gen.c
...
cc $CFLAGS -c shu_su_stubs.c -o shu_su_stubs.o
...
cc $CFLAGS_DRIVER -o shu_su \
  ...
  ast_su.o token_su.o lexer_su.o parser_su.o typeck_su.o codegen_su.o \
  driver_su.o pipeline_su.o runtime_panic.o \
...
./shu_su -su -E ../tests/su-pipeline/hello.su 2>&1 || true
